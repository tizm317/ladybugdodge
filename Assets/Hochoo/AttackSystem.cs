...
public class AttackSystem : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //        Vector2 v2Two = (new Vector3(0, 0, 0) - transform.position).normalized;          // 2번
        ...
        //        FireMissileArray[1].gameObject.transform.Translate((new Vector3(0, 0, 0) - transform.position).normalized * MoveSpeed * Time.deltaTime);
